    ...
    for (Finger finger : hand.getFingers()) {
     switch(finger.getType()){
       case 1:
        ...
        if(hand.getStabilizedPosition().x < 454){
            countdecrease = 1;
            position = 3;
            fill(0,0,0, 180);
...
String cupSizeNames(int cupSize){
